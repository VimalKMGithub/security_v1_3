...
@Component
public class RefreshTokenEncrypterDecrypter extends AbstractConverter<String> {
    public RefreshTokenEncrypterDecrypter(AESUtilFactory aesUtilFactory) {
        super(aesUtilFactory, AESOperationType.REFRESH_TOKEN);
    }

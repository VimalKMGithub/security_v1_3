...
@Component
public class JwtIdEncrypterDecrypter extends AbstractConverter<String> {
    public JwtIdEncrypterDecrypter(AESUtilFactory aesUtilFactory) {
        super(aesUtilFactory, AESOperationType.JWT_ID);
    }

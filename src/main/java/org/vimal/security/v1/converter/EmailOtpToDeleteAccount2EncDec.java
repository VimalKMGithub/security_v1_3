...
@Component
public class EmailOtpToDeleteAccount2EncDec extends AbstractConverter<String> {
    public EmailOtpToDeleteAccount2EncDec(AESUtilFactory aesUtilFactory) {
        super(aesUtilFactory, AESOperationType.EMAIL_OTP_DELETE_ACCOUNT_2);
    }

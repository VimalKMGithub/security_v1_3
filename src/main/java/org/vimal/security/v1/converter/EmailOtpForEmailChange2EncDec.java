...
@Component
public class EmailOtpForEmailChange2EncDec extends AbstractConverter<String> {
    public EmailOtpForEmailChange2EncDec(AESUtilFactory aesUtilFactory) {
        super(aesUtilFactory, AESOperationType.EMAIL_OTP_EMAIL_CHANGE_2);
    }

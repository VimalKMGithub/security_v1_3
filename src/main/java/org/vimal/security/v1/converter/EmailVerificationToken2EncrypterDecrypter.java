...
@Component
public class EmailVerificationToken2EncrypterDecrypter extends AbstractConverter<String> {
    public EmailVerificationToken2EncrypterDecrypter(AESUtilFactory aesUtilFactory) {
        super(aesUtilFactory, AESOperationType.EMAIL_VERIFICATION_TOKEN_2);
    }

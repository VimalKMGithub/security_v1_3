...
@Component
public class EmailOtpForForgotPwd2EncDec extends AbstractConverter<String> {
    public EmailOtpForForgotPwd2EncDec(AESUtilFactory aesUtilFactory) {
        super(aesUtilFactory, AESOperationType.EMAIL_OTP_FORGOT_PWD_2);
    }

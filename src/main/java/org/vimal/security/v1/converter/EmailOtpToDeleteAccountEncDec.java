...
@Component
public class EmailOtpToDeleteAccountEncDec extends AbstractConverter<String> {
    public EmailOtpToDeleteAccountEncDec(AESUtilFactory aesUtilFactory) {
        super(aesUtilFactory, AESOperationType.EMAIL_OTP_DELETE_ACCOUNT);
    }
